...
// //     if (newQuantity < 1) return; // Prevent setting quantity < 1
// //     try {
// //       await axios.put(`http://localhost:8081/cart/${cartItemId}`, {
...
// //     try {
// //       await axios.post('http://localhost:8081/checkout', { userId });
...
//   //     localStorage.setItem('cart', JSON.stringify(fetchedCartItems)); // Save to localStorage
...
//     navigate('/checkout'); // <-- Step 3: Redirect to Checkout page
//   };
